...
do-build:
	cd ${WRKSRC} && ${CC} ${CFLAGS} ${LDFLAGS} -lspf2 -o ${PKGBASE} ${DISTNAME}

do-install:
	cd ${WRKSRC}; \
	${INSTALL_PROGRAM} ${PKGBASE} ${DESTDIR}${PREFIX}/bin/${PKGBASE}; \
	${INSTALL_DATA} ${DISTNAME} ${DESTDIR}${PREFIX}/share/doc/${PKGBASE}/README
